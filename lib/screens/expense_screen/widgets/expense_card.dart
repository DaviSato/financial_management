...
class ExpenseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      ...
      child: Card(
        // Quadrado e sem borda própria: o arredondamento e a borda vêm da
        // moldura externa (SwipeableCardFrame), para o card deslizar com borda
        // de fuga reta e não vazar o fundo do swipe nos cantos.
